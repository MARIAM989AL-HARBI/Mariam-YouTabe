...
class MainActivity : AppCompatActivity() {
    private val videos: Array<Array<Any>> =
        arrayOf(
            arrayOf("Starry Night:Painting by Vincent Van Gogh", "n9xQcpPwKzM",R.drawable.art),
            arrayOf("Tangled/Sing-Along", "ILRs2r6lcHY",R.drawable.movie),
            arrayOf("The Real you", "0u0j4Rh02KA",R.drawable.music),
